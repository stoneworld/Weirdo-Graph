...
export class weirdo extends ethereum.SmartContract {
  static bind(address: Address): weirdo {
    return new weirdo("weirdo", address);
  }
  ...
  PreMaxMint(): BigInt {
    let result = super.call("PreMaxMint", "PreMaxMint():(uint256)", []);

    return result[0].toBigInt();
  }

  try_PreMaxMint(): ethereum.CallResult<BigInt> {
    let result = super.tryCall("PreMaxMint", "PreMaxMint():(uint256)", []);
    if (result.reverted) {
      return new ethereum.CallResult();
    }
    let value = result.value;
  ...
  PublicMaxMint(): BigInt {
    let result = super.call("PublicMaxMint", "PublicMaxMint():(uint256)", []);

    return result[0].toBigInt();
  }

  try_PublicMaxMint(): ethereum.CallResult<BigInt> {
    let result = super.tryCall(
      "PublicMaxMint",
      "PublicMaxMint():(uint256)",
      []
    );
    if (result.reverted) {
      return new ethereum.CallResult();
  ...
  publicNumberMinted(owner: Address): BigInt {
    let result = super.call(
      "publicNumberMinted",
      "publicNumberMinted(address):(uint256)",
      [ethereum.Value.fromAddress(owner)]
    );
  ...
  try_publicNumberMinted(owner: Address): ethereum.CallResult<BigInt> {
    let result = super.tryCall(
      "publicNumberMinted",
      "publicNumberMinted(address):(uint256)",
      [ethereum.Value.fromAddress(owner)]
...
export class SetSignerOfNumCall extends ethereum.Call {
  get inputs(): SetSignerOfNumCall__Inputs {
    return new SetSignerOfNumCall__Inputs(this);
  }

  get outputs(): SetSignerOfNumCall__Outputs {
    return new SetSignerOfNumCall__Outputs(this);
  }
}

export class SetSignerOfNumCall__Inputs {
  _call: SetSignerOfNumCall;

  constructor(call: SetSignerOfNumCall) {
    this._call = call;
  }
...
export class SetSignerOfNumCall__Outputs {
  _call: SetSignerOfNumCall;
